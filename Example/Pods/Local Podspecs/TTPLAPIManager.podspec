...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of TTPLAPIManager."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/TTPLAPIManager"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Subramanian" => "mailmemani@ymail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/TTPLAPIManager.git", :tag => s.version.to_s }
